...
| Ferramenta        | Descrição                       | Url                                                                |
| ----------------- | ------------------------------- | ------------------------------------------------------------------ |
| DBeaver Community | Cliente para bancos de dados.   | [:octicons-link-24:](https://dbeaver.io/download/){target=\_blank} |
| HeidiSQL          | Cliente para bancos de dados.   | [:octicons-link-24:](https://www.heidisql.com/){target=\_blank}    |
